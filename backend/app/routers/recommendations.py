...
def get_student_recommendations(
    ...
    query = db.query(RecommendationInstance).filter(
    ...
    recommendations = query.order_by(RecommendationInstance.priority, RecommendationInstance.generated_at.desc()).all()
