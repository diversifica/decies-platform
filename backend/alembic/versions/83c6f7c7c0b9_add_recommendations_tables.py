...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_index(
        op.f("idx_microconcepts_subject"), "microconcepts", ["subject_id"], unique=False
    )
    op.create_index(
        op.f("idx_metric_aggregates_student"), "metric_aggregates", ["student_id"], unique=False
    )
    op.create_index(
        op.f("idx_mastery_states_student"), "mastery_states", ["student_id"], unique=False
    )
    op.create_index(
        op.f("idx_learning_events_student"), "learning_events", ["student_id"], unique=False
    )
    op.create_index(
        op.f("idx_learning_events_session"), "learning_events", ["session_id"], unique=False
    )
    op.create_index(
        op.f("idx_activity_sessions_student"), "activity_sessions", ["student_id"], unique=False
    )
    # ### end Alembic commands ###
