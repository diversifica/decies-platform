...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["subject_id"], ["subjects.id"], name="microconcepts_subject_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["microconcept_id"], ["microconcepts.id"], name="mc_prereq_microconcept_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["prerequisite_microconcept_id"],
            ["microconcepts.id"],
            name="mc_prereq_prerequisite_id_fkey",
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["student_id"], ["students.id"], name="activity_sessions_student_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["activity_type_id"],
            ["activity_types.id"],
            name="activity_sessions_activity_type_id_fkey",
        ),
        sa.ForeignKeyConstraint(
            ["subject_id"], ["subjects.id"], name="activity_sessions_subject_id_fkey"
        ),
        sa.ForeignKeyConstraint(["term_id"], ["terms.id"], name="activity_sessions_term_id_fkey"),
        sa.ForeignKeyConstraint(
            ["topic_id"], ["topics.id"], name="activity_sessions_topic_id_fkey"
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["session_id"], ["activity_sessions.id"], name="activity_session_items_session_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["item_id"], ["items.id"], name="activity_session_items_item_id_fkey"
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["student_id"], ["students.id"], name="learning_events_student_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["session_id"], ["activity_sessions.id"], name="learning_events_session_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["subject_id"], ["subjects.id"], name="learning_events_subject_id_fkey"
        ),
        ...
        sa.ForeignKeyConstraint(
            ["microconcept_id"], ["microconcepts.id"], name="learning_events_microconcept_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["activity_type_id"],
            ["activity_types.id"],
            name="learning_events_activity_type_id_fkey",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["student_id"], ["students.id"], name="metric_aggregates_student_id_fkey"
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column("microconcept_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column(
            "mastery_score", sa.Numeric(precision=6, scale=4), nullable=False, server_default="0"
        ),
        sa.Column(
            "status",
            postgresql.ENUM(
                "dominant", "in_progress", "at_risk", name="mastery_status", create_type=False
            ),
            nullable=False,
        ...
        sa.ForeignKeyConstraint(
            ["student_id"], ["students.id"], name="mastery_states_student_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["microconcept_id"], ["microconcepts.id"], name="mastery_states_microconcept_id_fkey"
        ),
    )
    ...
    op.add_column(
        "items", sa.Column("microconcept_id", postgresql.UUID(as_uuid=True), nullable=True)
    )
    op.create_foreign_key(
        "items_microconcept_id_fkey", "items", "microconcepts", ["microconcept_id"], ["id"]
    )
